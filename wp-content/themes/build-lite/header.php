...
<div class="headertop">
  <div class="container">
    ...
    <div class="right">
          ...
          <?php esc_attr_e('Liên Hệ Ngay!','build-lite'); ?>
          </a>
          <?php } ?>
    </div>
    <div class="clear"></div>
  ...
  <div class="container">
    <div class="logo">
      <h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>">
        <img width="420px" src="http://mangcopof.com/wp-content/uploads/2016/04/LOGO-1.png" alt="Công ty THHH Thiết Bị Vật Tư Thành Lợi">
...
<?php if ( 1 /*is_front_page() && ! is_home() */) { ?>
<!-- Slider Section -->
...
<section id="home_slider">
  <div class="slider-wrapper theme-default">
    ...
    <div id="slidecaption1" class="nivo-html-caption">
      <div class="slide_info">
        <h2>
          <?php esc_html_e('Màng co POF nhập khẩu giá rẻ', 'build-lite');?>
        </h2>
      </div>
    </div>
    <div id="slidecaption2" class="nivo-html-caption">
      <div class="slide_info">
        <h2>
          <?php esc_html_e('Sản phẩm chất lượng hàng đầu', 'build-lite'); ?>
        </h2>
      </div>
    </div>
    <div id="slidecaption3" class="nivo-html-caption">
      <div class="slide_info">
        <h2>
          <?php esc_html_e('Hàng luôn có sẵn trong kho', 'build-lite');?>
        </h2>
      </div>
    </div>
  </div>

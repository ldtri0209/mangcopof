...
class WPSEO_Option_Titles extends WPSEO_Option {
	...
	public function translate_defaults() {
		...
		$this->defaults['title-search-wpseo'] = sprintf( __( 'Tìm kiếm %s', 'wordpress-seo' ), '%%searchphrase%%' ) . ' %%page%% %%sep%% %%sitename%%';
		$this->defaults['title-404-wpseo']    = __( 'Không tìm thấy trang', 'wordpress-seo' ) . ' %%sep%% %%sitename%%';
	}
